...
export KEPTN_ENDPOINT=http://$INGRESS_HOST.nip.io/api >> $RC_FILE
...
echo "export KEPTN_API_TOKEN=$KEPTN_API_TOKEN" >> $RC_FILE
echo "export KEPTN_ENDPOINT=$KEPTN_ENDPOINT" >> $RC_FILE
